const { Flights } = require("./flights.class");
const createModel = require("./flights.model");
...
module.exports = function (app) {
  ...
  app.use("/flights", new Flights(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("flights");

  // Get the schema of the collections 
  app.get("/flightsSchema", function (request, response) {
