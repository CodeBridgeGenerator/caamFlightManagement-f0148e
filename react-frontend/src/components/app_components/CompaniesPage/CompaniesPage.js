...
const CompaniesPage = (props) => {
  ...
  const onClickSaveHiddenfields = (ff) => {
    ...
    const onRowClick = ({data}) => {
        ...
        navigate(`/app/companies/${data._id}`);
    };
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="companies-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="companies-datatable">
                    <CompaniesDatatable items={data} fields={fields} onRowDelete={onRowDelete} onEditRow={onEditRow} onRowClick={onRowClick} searchDialog={searchDialog} setSearchDialog={setSearchDialog}
