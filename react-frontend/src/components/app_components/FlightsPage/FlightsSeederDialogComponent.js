...
import seederData from "./flights.seeder.json";
...
const FlightsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(FlightsSeederDialogComponent);
